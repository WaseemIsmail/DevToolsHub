...
export default function JsonFormatter() {
  ...
  return (
    <>
      <Helmet>
        <title>JSON Formatter | DevToolsHub</title>
        <meta
          name="description"
          content="Format and validate JSON data instantly. This free online JSON formatter helps developers and testers make JSON easier to read, debug, and use in applications."
        />
        <meta
          name="keywords"
          content="json formatter, json validator, format json, online json formatter, developer tools, json beautifier"
        />
        <link
          rel="canonical"
          href="https://devtoolshub-tools.netlify.app/json-formatter"
        />
        <meta property="og:title" content="JSON Formatter | DevToolsHub" />
        <meta
          property="og:description"
          content="Free online JSON formatter and validator for developers and testers."
        />
        <meta
          property="og:url"
          content="https://devtoolshub-tools.netlify.app/json-formatter"
        />
        <meta property="og:type" content="website" />
        <meta
          name="twitter:title"
          content="JSON Formatter | DevToolsHub"
        />
        <meta
          name="twitter:description"
          content="Format and validate JSON instantly using this free online tool."
        />
      </Helmet>
