...
export default function SQLFormatter() {
  ...
  return (
    <>
      <Helmet>
        <title>SQL Formatter | DevToolsHub</title>
        <meta
          name="description"
          content="Format and beautify SQL queries for better readability. This free online SQL formatter helps developers, analysts, and database users organize raw queries into a cleaner structure."
        />
        <meta
          name="keywords"
          content="sql formatter, format sql, sql beautifier, online sql formatter, sql prettifier, devtools hub"
        />
        <link
          rel="canonical"
          href="https://devtoolshub-tools.netlify.app/sql-formatter"
        />
        <meta property="og:title" content="SQL Formatter | DevToolsHub" />
        <meta
          property="og:description"
          content="Format and beautify SQL queries for better readability with this free online SQL formatter."
        />
        <meta
          property="og:url"
          content="https://devtoolshub-tools.netlify.app/sql-formatter"
        />
        <meta property="og:type" content="website" />
        <meta
          name="twitter:title"
          content="SQL Formatter | DevToolsHub"
        />
        <meta
          name="twitter:description"
          content="Format and beautify SQL queries for better readability with this free online tool."
        />
      </Helmet>
