...
export default function LoremIpsum() {
  ...
  return (
    <>
      <Helmet>
        <title>Lorem Ipsum Generator | DevToolsHub</title>
        <meta
          name="description"
          content="Generate placeholder Lorem Ipsum text instantly for design, prototyping, wireframes, content mockups, and front-end development."
        />
        <meta
          name="keywords"
          content="lorem ipsum generator, placeholder text generator, dummy text generator, lorem ipsum tool, devtools hub"
        />
        <link
          rel="canonical"
          href="https://devtoolshub-tools.netlify.app/lorem-ipsum"
        />
        <meta
          property="og:title"
          content="Lorem Ipsum Generator | DevToolsHub"
        />
        <meta
        ...
        <meta
          property="og:url"
          content="https://devtoolshub-tools.netlify.app/lorem-ipsum"
        />
