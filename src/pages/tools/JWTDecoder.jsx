...
export default function JWTDecoder() {
  ...
  return (
    <>
      <Helmet>
        <title>JWT Decoder | DevToolsHub</title>
        <meta
          name="description"
          content="Decode and inspect JWT tokens instantly. This free online JWT decoder helps developers read the header and payload of a JSON Web Token in a readable format."
        />
        <meta
          name="keywords"
          content="jwt decoder, decode jwt, json web token decoder, jwt payload decoder, jwt header decoder, developer tools"
        />
        <link
          rel="canonical"
          href="https://devtoolshub-tools.netlify.app/jwt-decoder"
        />
        <meta property="og:title" content="JWT Decoder | DevToolsHub" />
        <meta
          property="og:description"
          content="Free online JWT decoder to inspect token header and payload instantly."
        />
        <meta
          property="og:url"
          content="https://devtoolshub-tools.netlify.app/jwt-decoder"
        />
        <meta property="og:type" content="website" />
        <meta name="twitter:title" content="JWT Decoder | DevToolsHub" />
        <meta
          name="twitter:description"
          content="Decode and inspect JWT tokens instantly using this free online tool."
        />
      </Helmet>
