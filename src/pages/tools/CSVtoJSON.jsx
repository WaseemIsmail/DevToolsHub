...
export default function CSVtoJSON() {
  ...
  return (
    <>
      {/* SEO */}
      <Helmet>
        <title>CSV to JSON Converter | DevToolsHub</title>
        <meta
          name="description"
          content="Convert CSV data into structured JSON format instantly. Free online CSV to JSON converter for developers and analysts."
        />
        <meta
          name="keywords"
          content="csv to json, csv converter, json converter, developer tools, csv parser"
        />
        <link
          rel="canonical"
          href="https://devtoolshub-tools.netlify.app/csv-to-json"
        />

        {/* Open Graph */}
        <meta property="og:title" content="CSV to JSON Converter | DevToolsHub" />
        <meta
          property="og:description"
          content="Free online tool to convert CSV into JSON instantly."
        />
        <meta
          property="og:url"
          content="https://devtoolshub-tools.netlify.app/csv-to-json"
        />
        <meta property="og:type" content="website" />

        {/* Twitter */}
        <meta name="twitter:title" content="CSV to JSON Converter | DevToolsHub" />
        <meta
          name="twitter:description"
          content="Convert CSV data to JSON instantly using this free tool."
        />
      </Helmet>
    ...
    "city": "Kandy"
          ...
          <div className="bg-white shadow-md rounded-xl p-6 md:p-8 border">
            ...
            <div className="space-y-5">
              ...
              <div>
                ...
                <p className="text-gray-700 leading-relaxed">
                  JSON is widely used in APIs and applications, making data easier
              ...
              <div>
                ...
                <p className="text-gray-700 leading-relaxed">
                  Works best with standard CSV. Complex formats may need extra parsing.
                </p>
              </div>
            </div>
          </div>
          ...
          <div className="bg-white shadow-md rounded-xl p-6 md:p-8 border">
            ...
            <div className="flex flex-wrap gap-4">
              <Link to="/json-to-csv" className="text-blue-600 hover:underline font-medium">
                JSON to CSV
              </Link>
              <Link to="/json-formatter" className="text-blue-600 hover:underline font-medium">
                JSON Formatter
              </Link>
              <Link to="/sql-formatter" className="text-blue-600 hover:underline font-medium">
                SQL Formatter
              </Link>
              <Link to="/base64-encoder" className="text-blue-600 hover:underline font-medium">
                Base64 Encoder
              </Link>
            </div>
          </div>
