...
export default function Base64Tool() {
  ...
  return (
    <>
      <Helmet>
        <title>Base64 Encoder / Decoder | DevToolsHub</title>
        <meta
          name="description"
          content="Encode plain text to Base64 or decode Base64 back into readable text instantly with this free online Base64 encoder and decoder tool."
        />
        <meta
          name="keywords"
          content="base64 encoder, base64 decoder, online base64 tool, encode base64, decode base64, developer tools"
        />
        <link
          rel="canonical"
          href="https://devtoolshub-tools.netlify.app/base64-encoder"
        />

        <meta
          property="og:title"
          content="Base64 Encoder / Decoder | DevToolsHub"
        />
        <meta
          property="og:description"
          content="Free online Base64 encoder and decoder for developers, testers, and students."
        />
        <meta
          property="og:url"
          content="https://devtoolshub-tools.netlify.app/base64-encoder"
        />
        ...
        <meta
          ...
          content="Encode and decode Base64 strings instantly using this free online tool."
        />
      </Helmet>
        ...
        <div className="max-w-5xl mx-auto space-y-10">
          ...
          <div className="bg-white shadow-md rounded-xl p-6 md:p-8 border">
            ...
            <p className="text-gray-700 leading-relaxed mb-4">
              ...
              string made up of letters, numbers, and symbols. It is commonly
              used when binary or special data needs to be transferred safely in
              text form.
            </p>

            <p className="text-gray-700 leading-relaxed">
              Developers often use Base64 when working with APIs, tokens, file
              conversions, email content, or encoded payloads. Base64 encoding
              is not encryption, so it should not be used to protect sensitive
              data.
            </p>
          </div>
          ...
          <div className="bg-white shadow-md rounded-xl p-6 md:p-8 border">
            ...
            <div className="space-y-3 text-gray-700 leading-relaxed">
              ...
              <p>
                2. Click <strong>Encode</strong> to generate the Base64 output.
              </p>
              <p>
                3. Enter a Base64 string if you want to convert it back to text.
              </p>
              <p>
                4. Click <strong>Decode</strong> to see the readable result.
              </p>
            ...
            <div className="space-y-5">
              <div>
                ...
                <p className="text-gray-700 leading-relaxed">
                  ...
                  transfer in text form, but it does not secure or hide data
              ...
              <div>
                ...
                <p className="text-gray-700 leading-relaxed">
                  Base64 is useful when data needs to be represented safely as
                  text, especially in APIs, emails, and configuration values.
                </p>
              </div>
              ...
              <div>
                ...
                <p className="text-gray-700 leading-relaxed">
                  You can decode valid Base64 strings. If the input is invalid
                  or incomplete, the tool may show an error.
                </p>
              </div>
            </div>
          </div>
