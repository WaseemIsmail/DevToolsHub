...
export default function ColorConverter() {
  ...
  return (
    <>
      <Helmet>
        <title>Color Converter | DevToolsHub</title>
        <meta
          name="description"
          content="Convert colors between HEX and RGB formats instantly with this free online color converter. Useful for developers, designers, and anyone working with web colors."
        />
        <meta
          name="keywords"
          content="color converter, hex to rgb, rgb to hex, hex converter, rgb converter, css color tool, web color converter"
        />
        <link
          rel="canonical"
          href="https://devtoolshub-tools.netlify.app/color-converter"
        />
        <meta property="og:title" content="Color Converter | DevToolsHub" />
        <meta
          property="og:description"
          content="Free online tool to convert HEX and RGB color values instantly."
        />
        <meta
          property="og:url"
          content="https://devtoolshub-tools.netlify.app/color-converter"
        />
        <meta property="og:type" content="website" />
        <meta name="twitter:title" content="Color Converter | DevToolsHub" />
        <meta
          name="twitter:description"
          content="Convert HEX to RGB and RGB to HEX instantly using this free online tool."
        />
      </Helmet>
